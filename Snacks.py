...
# base_url = "https://diabetesfoodhub.org/recipes/lunch"
...
# print("All recipe data has been saved to Lunch.json")
...
# Base URL of the recipes listing page
base_url = "https://diabetesfoodhub.org/recipes/snacks"
all_recipes = scrape_all_recipes(base_url)

# Save the data to a JSON file
with open("Snacks-final.json", "w") as json_file:
    json.dump(all_recipes, json_file, indent=4)

print("All recipe data has been saved to Snacks-final.json")
