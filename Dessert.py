...
base_url = "https://diabetesfoodhub.org/recipes/dessert"
all_recipes = scrape_all_recipes(base_url)

# Save the data to a JSON file
with open("Final_Dessert.json", "w") as json_file:
    json.dump(all_recipes, json_file, indent=4)

print("All recipe data has been saved to final_dessert.json")
